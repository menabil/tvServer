...
//           className="grid h-10 w-10 place-items-center rounded-full text-[var(--text-muted)] transition-colors hover:bg-[var(--surface-2)] hover:text-[var(--accent)]"
//         >
//           <Shuffle size={17} />
//         </button>
//       </div>
...
//               }`}
//             >
//               <span className="grid h-14 w-14 shrink-0 place-items-center overflow-hidden rounded-lg bg-[var(--surface-2)]">
//                 {channel.logo ? (
//                   <img
//                     src={channel.logo}
//                     alt=""
